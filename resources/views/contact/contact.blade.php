...
@section('content')
    <div class="google-maps">
        <div id="map" class="map contact-map">
            @include('layouts.public.partials.google_map')
        </div>
    </div>
                    ...
                    <div class="contact-us">
                        <div class="row">
                            <div class="col-md-8 col-sm-7">
                             @if(Session::has('message')) <div class="alert alert-success"> {{Session::get('message')}} </div> @endif
                                ...
                                <form class="contact-form" action="/Send_message" method="POST">
                                    ...
                                    <div class="form-group">
                                        <textarea id="form-message" name="message" class="form-control" placeholder="Write your message here *" rows="4" required="required" data-error="Please,leave us a message."></textarea>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-5">
                                ...
                                <div class="reach"><span class="phone-icon"><i class="icon ion-android-call"></i></span><p>+88-0180000000</p></div>
                                <div class="reach"><span class="phone-icon"><i class="icon ion-email"></i></span><p>bbitbook@gmail.com</p></div>
                                <div class="reach"><span class="phone-icon"><i class="icon ion-ios-location"></i></span><p>Dhaka,Bangladesh</p></div>
