            ...
            <div id="page-contents">
                <div class="row">
                    <div class="col-md-3">
                        <!--Edit Profile Menu-->
                        <ul class="edit-menu">
                            <li class="active"><i class="icon ion-ios-information-outline"></i><a href="{{ url('/Timeline-edit-profile') }}">Basic Information</a></li>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="edit-profile-container">
                            ...
                            <div class="edit-block">
                                {!! Form::open(['url' => '/Timeline-edit-profile' , 'method' => 'POST', 'enctype'=>'multipart/form-data','file'=>true ]) !!}
                                ...
                                {{--<form name="basic-info" id="basic-info" class="form-inline">--}}
                                    <div class="row">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input id="fullname" class="form-control input-group-lg" type="text" name="fullname" title="Enter full name" placeholder="Full name"/>
                                    </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-xs-6">
                                            ...
                                            <select class="form-control" id="language" name="language">
                                                ...
                                                <option >Bangla, Hindi</option>
                                                <option >English, Hindi</option>
                                                <option >Bangla, English, Hindi</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-3 col-xs-6">
                                            <label for="dob_month" class="sr-only"></label>
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label for="dob_year" class="sr-only"></label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-xs-6">
                                            <label for="my_city"> Your city</label>
                                            <input id="my_city" class="form-control input-group-lg" type="text" name="my_city" title="Enter city" placeholder="Your city"/>
                                        </div>
                                        <div class="form-group col-xs-6">
                                            <label for="my_country">Your country</label>
                                            <select class="form-control" id="my_country" name="my_country">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <textarea id="about_me" name="about_me" class="form-control" placeholder="Some texts about me" rows="4" cols="400"></textarea>
                                        </div>
                                    </div>
