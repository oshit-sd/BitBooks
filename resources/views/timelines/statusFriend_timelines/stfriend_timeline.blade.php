                                    ...
                                    <div class="post-detail">
                                        ...
                                        <div style="height: 38px;">
                                            <div style="width: 120px; float: left;">
                                                <form action="{{ url('/StFriendLikes/'.$item->u_id) }}" method="post">
                                                    {{ csrf_field() }}
                                            ...
                                            <div style="width: 120px; float: left;">
                                                <a href="{{ url('/StFriendsComments/'.$item->id)  }}" class="btn text-black" style="float: left;">
                                        ...
                                        <div class="line-divider"></div>
                                        @include('layouts.public.partials.stfriend_post-comment')
                                    </div>
                                </div>
                            </div>
                        @endforeach
