                            ...
                            <div class="grid-item col-md-6 col-sm-6">
                                <div class="media-grid">
                                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-7">
                                        <img src="{{ asset ('assets/images/post-images/1.jpg')}}" alt="" class="img-responsive post-image" />
                                    </div>
                                    <div class="media-info">
                                        ...
                                        <div class="user-info">
                                            <img src="{{ asset ('assets/images/users/user-5.jpg')}}" alt="" class="profile-photo-sm pull-left" />
                                            <div class="user">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="post-content">
                                                    <img src="{{ asset ('assets/images/post-images/1.jpg')}}" alt="post-image" class="img-responsive post-image" />
                            ...
                            <div class="grid-item col-md-6 col-sm-6">
                                <div class="media-grid">
                                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-8">
                                        <img src="{{ asset ('assets/images/post-images/9.jpg')}}" alt="" class="img-responsive post-image" />
                                    </div>
                                    <div class="media-info">
                                        <div class="reaction">
