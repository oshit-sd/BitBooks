<form name="StFriendsComments" action={{ url('/StFriendsComments/'.$item->id.'/'.$item->u_id)  }} method="post">
    {{ csrf_field() }}
    ...
    <div class="post-comment">
        ...
        <input type="text" title="Write your comment" name="c_details" id="comment" required="required" style="height: 30px; width: 250px; border: 1px solid #ccc; border-radius: 5px;" placeholder="  Post a comment">
